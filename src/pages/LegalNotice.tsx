    ...
    <div className="min-h-screen bg-background py-20">
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <section className="mb-8">
          ...
          <p className="mb-2"><strong>EnvironnementCEE.fr</strong> est exploité par <strong>TravauxHub SAS</strong></p>
          ...
          <p className="mt-4 text-muted-foreground text-sm">
            EnvironnementCEE.fr est une marque de TravauxHub, plateforme de mise en relation entre particuliers et artisans certifiés RGE.
          </p>
        </section>

...
export const fenetresFormSchema = z.object({
  // Type de logement
  building_type: z.string().min(1, "Sélectionnez le type de logement"),
  
  // Fenêtres
  nb_fenetres: z.number().min(1, "Le nombre de fenêtres doit être d'au moins 1").max(50, "Maximum 50 fenêtres"),
  current_window_type: z.enum(["simple", "double_ancien", "aucune"], {
    required_error: "Sélectionnez le type de vitrage actuel",
  }),
...
export type FenetresFormData = z.infer<typeof fenetresFormSchema>;
